...
const Navbar = () => {
  ...
  const {user, logOut} = useContext(AuthContext)
    ...
    <li> <NavLink
            to="/"
            className={({ isActive }) =>
              isActive ? "text-black bg-blue-gray-50 font-extrabold border-b-8 border-[#E76F51] " : ""
            }
          > Home</NavLink></li>
    <li> <NavLink
            to="/services"
  ...
  <div className="navbar-end">

    {
      user?.email? <div className="flex flex-col items-center">
         <div className="w-10 rounded-full"><img className="rounded-full" src={user.photoURL} alt="" /></div>
